...
down_revision: Union[str, None] = 'dff01af2f411'
...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'chats', 'groups', ['group_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key(None, 'groups', 'users', ['creator_id'], ['id'], ondelete='CASCADE')
...
def downgrade() -> None:
    ...
    op.create_foreign_key('chats_group_id_fkey', 'chats', 'groups', ['group_id'], ['id'])
