...
- **Подключение с нескольких устройств** — поддержка мульти-девайс подключения (опционально, дополнительная задача).
- **Юнит-тесты** — рекомендуется реализовать тесты с использованием Pytest для повышения качества кода.
- **Уведомления о прочтении сообщений** — в текущей версии реализована отметка сообщений как прочитанных, но уведомление
  отправителю может быть доработано.
